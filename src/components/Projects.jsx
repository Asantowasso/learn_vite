  ...
  return (
    <div id="projects" className="max-w-[1040px] m-auto md:pl-20 p-4 py-16 bg-[#252525]">
      ...
      <div className="grid sm:grid-cols-2 gap-12">
        <Projectitem img={Vet} desc="Users can create a profile for their pet to be viewed by a veterinarian" title="Pet-to-Vet" url="https://github.com/Asantowasso/pet-to-vet" deployed="https://damp-forest-39395.herokuapp.com/login"/>
